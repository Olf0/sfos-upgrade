...
Omit running `post_sfos-upgradesfos-upgrade` between consecutive SailfishOS upgrades (but do reboot each time!), only run it once after having installed the recent version.
