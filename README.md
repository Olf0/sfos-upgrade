...
You may omit running `post_sfos-upgrade` between consecutive SailfishOS upgrades (but do reboot each time!), but must run it after having upgraded to the intended version.
